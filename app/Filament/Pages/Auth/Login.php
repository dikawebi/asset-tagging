...
class Login extends BaseLogin
{
    ...
    {
        return 'Masuk — PT Borneo Prima Asset Tagging';
    }
    ...
    public function getSubheading(): string | Htmlable | null
    {
        ...
        return new HtmlString(
            'Masuk untuk mengelola <span class="font-semibold text-gray-900 dark:text-white">inventaris aset PT Borneo Prima</span> — cepat, akurat, dan terpantau.'
        );
    }
